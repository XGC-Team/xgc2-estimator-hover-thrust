...
Depends: libxgc2-observer-dev (>= 0.3.2-1), libxgc2-state-machine-dev, ros-noetic-xgc2-ros1-utils, ros-noetic-message-runtime, ros-noetic-roscpp, ros-noetic-std-msgs, ros-noetic-sensor-msgs, ros-noetic-geometry-msgs, ros-noetic-mavros-msgs
